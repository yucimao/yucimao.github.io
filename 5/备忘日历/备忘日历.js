...
let rlxa = new Date();
rlxa = rlxa - rlx;
let 希尔日 = Math.floor(rlxa / (24 * 3600 * 1000));
let 希尔月;
let 希尔年 = 4300 + parseInt(希尔日/47619)*100;
	希尔日 = 希尔日 % 47619;
let rlxend=0;
let 临时年;
...
/* x月第x个星期x */
var 第x个=parseInt(盖亚日/7);
var 第y个=盖亚日%7;
if (第y个!=0){第x个=第x个+1;}
var 剩余天数 = new Date(盖亚年, 盖亚月, 0).getDate()-盖亚日+1;
var 倒数第x个=parseInt(剩余天数/7);
var 倒数第y个=剩余天数%7;
if (倒数第y个!=0){倒数第x个=倒数第x个+1;}

var 盖亚历=盖亚年+"年"+盖亚月+"月"+盖亚日+"日 星期"+盖亚星期;
var 农历=农历月+"月"+农历日;
var 希尔历=希尔年+"年"+希尔月+"月"+希尔日+"日";
var 日期="<b>盖亚历</b> " + 盖亚历 + "<br/><b>农历</b> " + 农历 + "<br/><b>希尔历</b> " + 希尔历;
