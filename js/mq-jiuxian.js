...
<script>
let 表={ //"名字_不同版本":["颜色","颜色／文字"], 酒、水、人、白 绿、白、黄 留空为灰
// "":["酒","／"],
};
...
function 进入(){
    if(表[o]){
        ...
        for(let i=0;oo.length>i;i++){
            ...
            // if(临时[0]=="价格"){dy+="<div class='标题 价格'>出售单价："+临时[1]+"</div>";}else 
            if(临时[0]=="代码"){
